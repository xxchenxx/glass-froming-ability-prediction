...
for seed in range(42,43):
    ...
    data = pickle.load(open(f"data/data_split_5_percent.pkl", "rb"))
    y = data['train_labels']
    X = data['train_Xs']
            ...
            for name, m in model.named_modules():
                if isinstance(m, MaskedConv2d):
                    if not no_beta:
                        ...
                        m2 = beta <= -lr * 3e-3
                        m3 = (beta.abs() < lr * 3e-3)
                        m.mask_beta.data[m1] = m.mask_beta.data[m1] - lr * 3e-3
                        m.mask_beta.data[m2] = m.mask_beta.data[m2] + lr * 3e-3
                    ...
                    if not no_alpha:
                        ...
                        m1 = alpha >= lr * 3e-3
                        m2 = alpha <= -lr * 3e-3
                        m3 = (alpha.abs() < lr * 3e-3)
                        m.mask_alpha.data[m1] = m.mask_alpha.data[m1] - lr * 3e-3
                        m.mask_alpha.data[m2] = m.mask_alpha.data[m2] + lr * 3e-3
